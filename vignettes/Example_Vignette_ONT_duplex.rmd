...
# Sample name
sample_name <- "HG002_ONT_duplex"

# Create results directory
dir.create(file.path(paths$example_results, sample_name), 
           showWarnings = FALSE)

sample_file <- file.path("/home/jake/science_projects/telo/shared_data/hs/data/ONT_duplex/SRR282957_comb.fastq")
...
# Save telomere_stats
saveRDS(search_res, file.path(paths$example_results,
                                  sample_name,
                                  "telomere_stats.rds"))
```
