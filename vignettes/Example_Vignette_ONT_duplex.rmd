...
# Download fastq file
prefetch --progress --resume yes -X 500G ERR11028096
fastq-dump ERR11028096
```
...
sample_file <- file.path(paste0("~/tmp/comparative_study_temp/", sample_name, ".fastq"))
reference_file <- file.path("~/tmp/comparative_study_temp/ref/chm13v2.0.fa.gz")
data_dir <- tempdir()
results_dir <- file.path("~/tmp/comparative_study_temp", sample_name, "results")
...
fasta_fl <- truncate_file(
  combined_telomere_file = telomeres_file,
