...
sample_file <- file.path("/home/jake/tmp/comparative_study_temp/HG004/input/lr/HG004_lr.fastq")
...
reference_file <- file.path("/home/jake/tmp/comparative_study_temp/HG004/input/ref/hg002v1.0.1.fasta")
...
# Save windows                                       
saveRDS(windows, file.path(paths$example_results, 
                           sample_name, 
                           "windows.rds"))
# Satus
...
# Directories
win_file <- file.path(paths$example_results, 
        sample_name,
        "windows.rds")
...
# Truncate files
fasta_fl <- truncate_files(combined_telomere_file = telomeres_file, 
